function PopupWithForm(props) {
    ...
    <div className={"popup" + (props.isOpen ? 'popup_opened' : '')} id="{props.name}">
      <div className="popup__container">
        <form className="form" id="{props.formID}-form" name="{props.name}-form">
          <fieldset className="form__fieldset">
            ...
            <button className="form__button-submit" type="submit" title="Сохранить изменения">Сохранить</button>
          </fieldset>
        </form>
